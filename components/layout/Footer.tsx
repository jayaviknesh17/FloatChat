...
export default function Footer() {
  return (
    <footer className="w-full py-4 px-6 mt-auto border-t border-cyan-500/10 bg-[#020814]/80 backdrop-blur-md select-none text-[11px] sm:text-xs text-slate-400">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
        {/* Left Tech & Data Provenance Banner (Exact Reference Image Text) */}
        <div className="flex items-center gap-2 flex-wrap justify-center sm:justify-start tracking-wider font-semibold text-slate-400/90 uppercase text-[10px] sm:text-[11px]">
        ...
        <div className="flex items-center gap-2 text-cyan-300 font-medium tracking-wide">
          ...
          <span className="tracking-widest uppercase text-[10px] sm:text-[11px] font-bold">
