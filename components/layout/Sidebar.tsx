...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* Main Sidebar Container (Exact Match to Reference Image) */}
      <aside
      ...
      >
        ...
        <div className="p-5 pb-2 space-y-3">
          ...
          >
            ...
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-cyan-600 via-sky-500 to-blue-600 p-[1.5px] shadow-[0_0_15px_rgba(6,182,212,0.4)] group-hover:shadow-[0_0_20px_rgba(6,182,212,0.6)] transition-all">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold tracking-tight text-white group-hover:text-cyan-200 transition-colors">
                FloatChat
              </span>
              <span className="text-[11px] text-cyan-300/70 font-medium tracking-wide">
                Chat with the Ocean
              </span>
            </div>
          </Link>

          {/* Primary Action Button: New Chat (Exact Match with Reference Image) */}
          <button
            onClick={() => {
              setMobileOpen(false);
              onNewChat();
            }}
            className="w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-900/40 via-sky-800/30 to-blue-900/20 border border-cyan-400/30 text-white text-xs font-semibold hover:border-cyan-400/60 hover:shadow-[0_0_15px_rgba(34,211,238,0.25)] transition-all"
          >
        ...
        <div className="flex-1 overflow-y-auto px-3.5 py-2 space-y-4 select-none scrollbar-thin">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-medium transition-all ${
                    isActive
                      ? "bg-cyan-500/15 text-cyan-200 border border-cyan-500/30 shadow-[inset_0_0_10px_rgba(34,211,238,0.15)]"
          ...
          {/* Featured Queries Section (Exact Reference Image Items) */}
          <div>
        ...
        <div className="p-3.5 pt-2 border-t border-cyan-500/10 space-y-3 select-none">
          {/* Compact ARGO Status Card with 3D Globe (Exact Reference Image Design) */}
          <div className="p-3 rounded-xl bg-gradient-to-br from-[#061c38]/90 to-[#030e20]/95 border border-cyan-500/20 shadow-lg flex items-center gap-3">
            <div className="relative w-9 h-9 rounded-full bg-gradient-to-tr from-cyan-600 to-blue-500 p-[1px] shrink-0 shadow-[0_0_12px_rgba(6,182,212,0.4)]">
