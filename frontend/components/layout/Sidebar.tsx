  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-2 py-1.5 space-y-3 select-none scrollbar-thin">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center rounded-xl text-xs font-medium transition-all ${
                    isOpen ? "gap-2.5 px-2.5 py-1.5" : "w-10 h-10 mx-auto justify-center p-0"
                  } ${
                    isActive
                      ? "bg-cyan-500/15 text-cyan-200 border border-cyan-500/30 shadow-[0_0_10px_rgba(34,211,238,0.15)]"
          ...
          {/* Divider */}
          <div className="h-[1px] bg-gradient-to-r from-transparent via-cyan-500/15 to-transparent mx-1" />

          {/* Featured Queries Section (Visible in Open Mode) */}
          {isOpen && (
            <div className="animate-in fade-in duration-200">
              <div className="px-2.5 mb-1.5 flex items-center justify-between">
                <span className="text-[10px] font-semibold tracking-wider text-cyan-400/80 uppercase">
                  Featured Queries
                </span>
              </div>
        ...
        <div className="p-2 border-t border-cyan-500/10 space-y-2 select-none">
          {/* Data Status Card */}
          {isOpen ? (
            <div className="p-2.5 rounded-xl bg-[#061c38]/60 backdrop-blur-md border border-cyan-500/20 shadow-md flex items-center gap-2.5">
              <div className="relative w-8 h-8 rounded-full bg-gradient-to-tr from-cyan-600 to-blue-500 p-[1px] shrink-0 shadow-[0_0_10px_rgba(6,182,212,0.4)]">
                <div className="w-full h-full rounded-full bg-[#031124] flex items-center justify-center overflow-hidden">
                  <Globe2 className="w-4 h-4 text-cyan-300 animate-pulse-slow" />
                </div>
              </div>
              ...
              <div className="flex flex-col min-w-0 text-left">
                ...
                <span className="text-[10px] text-cyan-300/80 truncate">
                  {status.isRealDataConnected ? "15–25 floats/region" : "Backend offline"}
                </span>
            ...
            <div
              ...
              title={
                status.isRealDataConnected
                  ? "Real ARGO Data: 15–25 floats/region (Jul 2025)"
                  : "Development Mode: Backend offline (Jul 2025)"
              }
            >
          ...
          <div className={`text-xs text-slate-400 font-medium ${isOpen ? "grid grid-cols-2 gap-1" : "flex flex-col items-center gap-1"}`}>
            <button
              onClick={onOpenAbout}
